...
docker stop socat-registry; docker rm socat-registry; docker run -d -e "REG_IP=192.168.49.2" -e "REG_PORT=30400" --name socat-registry --network minikube -p 30400:5000 socat-registry
